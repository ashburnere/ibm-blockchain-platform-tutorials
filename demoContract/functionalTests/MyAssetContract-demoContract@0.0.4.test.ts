...
describe('MyAssetContract-demoContract@0.0.4' , () => {
    ...
    describe('setup', () => {
        it('should submit setup transaction', async () => {
            // TODO: Update with parameters of transaction
            const args: string[] = [];

            const response: Buffer = await SmartContractUtil.submitTransaction('MyAssetContract', 'setup', args, gateway);
    ...
    describe('createMyAsset', () => {
        it('should submit createMyAsset transaction', async () => {
            // TODO: populate transaction parameters
            const myAssetId: string = 'EXAMPLE';
            const assetName: string = 'EXAMPLE';
            const assetValue: string = 'EXAMPLE';
            const args: string[] = [ myAssetId, assetName, assetValue];
